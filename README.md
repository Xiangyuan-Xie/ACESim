...
ACESim 是一个面向 MuJoCo / Genesis 的载具仿真平台，支持多旋翼、机械臂协同、固定翼、VTOL、UUV 等场景，并支持与 PX4、ROS 2 等外部系统集成。
...
ACESim 提供统一的环境装配、仿真运行和部署入口。项目可以独立运行，也可以按需接入 PX4 和 ROS 2。
