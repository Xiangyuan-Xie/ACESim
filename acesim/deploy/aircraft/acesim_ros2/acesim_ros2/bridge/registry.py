...
from acesim_ros2.bridge.plugins.px4_controls import PLUGIN as PX4_CONTROLS_PLUGIN
from acesim_ros2.bridge.plugins.simulation_clock import PLUGIN as SIMULATION_CLOCK_PLUGIN
from acesim_ros2.bridge.plugins.vehicle_truth import PLUGIN as VEHICLE_TRUTH_PLUGIN

PLUGIN_REGISTRY: dict[str, BridgePluginSpec[Any]] = {
    SIMULATION_CLOCK_PLUGIN.bridge_name: SIMULATION_CLOCK_PLUGIN,
    PX4_CONTROLS_PLUGIN.bridge_name: PX4_CONTROLS_PLUGIN,
    ARM_STATE_PLUGIN.bridge_name: ARM_STATE_PLUGIN,
    VEHICLE_TRUTH_PLUGIN.bridge_name: VEHICLE_TRUTH_PLUGIN,
}
