...
from acesim_ros2.bridge.plugins.arm_command_px4 import PLUGIN as ARM_COMMAND_PX4_PLUGIN
from acesim_ros2.bridge.plugins.arm_command_ros import PLUGIN as ARM_COMMAND_ROS_PLUGIN
...
PLUGIN_REGISTRY: dict[str, BridgePluginSpec[Any]] = {
    ...
    ARM_COMMAND_ROS_PLUGIN.bridge_name: ARM_COMMAND_ROS_PLUGIN,
    ARM_COMMAND_PX4_PLUGIN.bridge_name: ARM_COMMAND_PX4_PLUGIN,
